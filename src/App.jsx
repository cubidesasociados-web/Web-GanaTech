    ...
    <>
      ...
      <header className="site-header">
        <div className="container nav-shell">
          <a href="#inicio" className="logo-wrap" aria-label="Ir al inicio" onClick={() => setMenuOpen(false)}>
        ...
        <nav id="mobile-nav" className={`mobile-nav ${menuOpen ? 'is-open' : ''}`} aria-label="Navegación móvil">
          {links.map((link) => (
      ...
      >
        <svg className="floating-cta-icon" viewBox="0 0 24 24" aria-hidden="true">
